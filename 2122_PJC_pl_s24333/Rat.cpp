...
void Rat::ult(Rat &enemy) {
    switch (this->type) {
        ...
        case WATER:
            ...
            break;
        case FIRE:
            std::cout << "used Fire type ultimate attack! The enemy was hit for " << str * (lvl + 1)
                      << "points of damage!\n";
            enemy.hp -= str * (lvl + 1);
        ...
        case STEEL:
            ...
            break;
        case ICE:
            std::cout << "used blizzard! Enemy can't move for " << lvl / 2 + 1 << " turns and your rat is healed for "
                      << this->str / 2 + 5 * (this->lvl / 2 + 1) << "hp\n";
